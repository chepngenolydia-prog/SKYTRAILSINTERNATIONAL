...
const WhatsAppButton = () => {
  ...
  return (
    ...
    >
      ...
      <span className="absolute right-full mr-4 bg-[#25D366] text-white font-bold text-xs py-2 px-4 rounded-lg shadow-lg opacity-0 group-hover:opacity-100 transition-opacity whitespace-nowrap pointer-events-none">
        Chat with us!
      </span>
      {isWiggling && (
